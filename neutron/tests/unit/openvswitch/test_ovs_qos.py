...
class OpenvswitchQoSTestCase(test_qos.QoSDBTestCase):
    ...
    def setUp(self, plugin=None):
        ...
        super(OpenvswitchQoSTestCase, self).setUp(PLUGIN_NAME)

    def tearDown(self):
        super(OpenvswitchQoSTestCase, self).tearDown()


class TestOpenvswitchQoS(OpenvswitchQoSTestCase,
                         test_qos.TestQoS):
    pass
