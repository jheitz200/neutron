...
DHCP_MODE_STATIC = 'static'
DHCP_V6_MODE_RAONLY = 'ra-only'
DHCP_V6_MODE_SLAAC = 'slaac'
DHCP_V6_MODE_RANAME = 'ra-names'
DHCP_V6_MODE_RASTATELESS = 'ra-stateless'

DHCP_MODES = [DHCP_MODE_STATIC, DHCP_V6_MODE_SLAAC,
              DHCP_V6_MODE_RAONLY, DHCP_V6_MODE_RANAME,
              DHCP_V6_MODE_RASTATELESS]
DHCP_v6_MODES = DHCP_MODES[1:]
RA_MODES = DHCP_v6_MODES[1:]
